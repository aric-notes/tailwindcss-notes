...
function App() {
  return (
    <div className="wkit-scrollbar-w-1 debug-blue h-screen overflow-x-auto border-2">
      <div className="fc sticky top-0 z-10 bg-gray-100 p-2 text-gray-400 x-2">
        <i className="inline-block size-5 bgi-[icon/my-edit.png]"></i>
        这个是测试ICON
      </div>
      ...
      <div className="layout-scroll-x debug max-h-40 gap-5 *:size-20">
        <figure>
          <img src="https://tva1.js.work/large/007S8ZIlgy1gexw87htqhj305k05k74o.jpg" />
        </figure>
        <figure>
          <img src="https://tva1.js.work/large/007S8ZIlgy1gexw87htqhj305k05k74o.jpg" />
        </figure>
      ...
      <figure className="layout-hover-img debug-green size-15 rounded-md">
        <img src="https://tva1.js.work/large/007S8ZIlgy1gexw87htqhj305k05k74o.jpg" alt="aric.zheng" />
      </figure>
      <figure className="layout-aspect-view-[50] debug my-5">
        <span className="corner-t wsui-opacity-bg-[30] m-2">Just a test</span>
