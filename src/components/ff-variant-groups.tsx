...
const FFVariantGroups = () => {
  ...
  console.log(tgv`absolute desktop:(lh-5.5,right-15,bottom-3) mobile:(lh-3,right-5.5,bottom-1)`);
  return (
    <>
      ...
      <hr />
      <div className={tgv`sm:(debug-red bg-red-200) md:(debug-blue bg-blue-200) flex`}>
        <h1>ReportDetail34</h1>
        <h1>ReportDetail56</h1>
      </div>
      <h1>Tgv error-1</h1>
      <div className={tgv`desktop:(lh-5.5,right-15,bottom-3) mobile:(lh-3,right-5.5,bottom-1) absolute`}>
        TgvError-with-comma
      </div>
      <hr />
    </>
